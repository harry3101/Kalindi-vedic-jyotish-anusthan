...
const pick = (list: string[], i: number, p: number) => list[(i * 5 + p * 7) % list.length];

export function getHoroscope(rashiIndex: number, period: Period) {
  ...
  return {
    ...
    lucky: {
      ...
      colour: ["Saffron", "Gold", "Maroon", "White", "Green", "Blue", "Yellow", "Cream"][(rashiIndex + p) % 8],
      day: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][(rashiIndex + p) % 7],
    },
    rashi: rashis[rashiIndex],
  };
}

export const festivals: Record<number, [number, string][]> = {
  1: [[14, "Makar Sankranti"], [26, "Vasant Panchami"]],
  2: [[15, "Maha Shivaratri"]],
  3: [[4, "Holika Dahan"], [5, "Holi"], [30, "Chaitra Navratri begins"]],
  ...
  11: [[8, "Diwali"], [12, "Chhath Puja"], [24, "Kartik Purnima"]],
  12: [[25, "Gita Jayanti"]],
};
